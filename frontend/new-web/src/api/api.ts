...
export const getWorkspace = (id: string, signal?: AbortSignal) =>
    requestJson<WorkspaceRecord>(endpoints.workspace(id), {signal});
...
export const listSessionsByWorkspace =
    (workspaceId: string, signal?: AbortSignal) =>
    requestJson<{items: SessionRecord[]}>(
        endpoints.workspaceSessions(workspaceId), {signal});

export const getSession = (id: string, signal?: AbortSignal) =>
    requestJson<SessionRecord>(endpoints.session(id), {signal});

export const listMessages = (sessionId: string, signal?: AbortSignal) =>
    requestJson<{session_id: string; items: MessageRecord[]}>(
        endpoints.sessionMessages(sessionId), {signal});
...
export const listTasks = (sessionId: string, signal?: AbortSignal) =>
    requestJson<{items: TaskRecord[]}>(
        endpoints.sessionTasks(sessionId), {signal});

export const listTaskEvents = (taskId: string, signal?: AbortSignal) =>
...
export const getActiveTasks = () =>
    requestJson<{items: ActiveTaskState[]}>(`${endpoints.tasks}/active`);
...
export const getExpert = (name: string) =>
    requestJson<Exponent>(endpoints.expert(name));

export const createExpert = (data: Partial<Exponent>) => requestJson<Exponent>(
    endpoints.experts, {method: 'POST', body: JSON.stringify(data)});
...
export const exportExperts = () =>
    requestJson<Record<string, Exponent>>(endpoints.expertsExport);

export const importExperts = (data: Record<string, unknown>) =>
    requestJson<{imported: number}>(
        endpoints.expertsImport, {method: 'POST', body: JSON.stringify(data)});
...
export const setConfigAgent = (data: Record<string, unknown>) =>
    requestJson<Record<string, unknown>>(
        endpoints.configAgent, {method: 'PUT', body: JSON.stringify(data)});
...
export const updateLlmProvider = (id: string, data: Partial<LlmProvider>) =>
    requestJson<LlmProvider>(
        endpoints.configLlmProvider(id),
        {method: 'PUT', body: JSON.stringify(data)});

export const deleteLlmProvider = (id: string) =>
    requestJson<{deleted: boolean}>(
        endpoints.configLlmProvider(id), {method: 'DELETE'});
...
export const setConfigWorkspace = (data: Record<string, unknown>) =>
    requestJson<Record<string, unknown>>(
        endpoints.configWorkspace, {method: 'PUT', body: JSON.stringify(data)});
